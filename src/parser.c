...
AST_T* parser_parse_variable_definition(parser_T* parser)
{
    ...
    parser_eat(parser, TOKEN_ID); //expecting var name
    parser_eat(parser, TOKEN_EQUALS); // expecting var name = 
    AST_T* variable_definition_value = parser_parse_expr(parser); // expecting value of expression
...
AST_T* parser_parse_variable(parser_T* parser)
{
    ...
    parser_eat(parser, TOKEN_ID); //var name or functional call name
